...
| `ARCHITECTURE_V06_SCF_AGENT_START_PROMPT.md` | Updated 2026-05-30 startup prompt for the next agent. It starts from DEC-011 / SPEC-20260530-001 ver2.0 SCF closure and directs L4 trained-state + temporal-metric planning without reopening broad architecture exploration |
...
| `SPEC-20260530-001-dream3r-ver2-scf-architecture.md` | 2026-05-30 accepted Dream3R-ver2.0 architecture spec. Defines SCF as bounded state-conditioned multi-expert fusion over real Fast3R / MASt3R / Spann3R proposals; records built surface, model contract, accepted claims, non-claims, and L4 next-version tasks |
| `SPEC-20260530-002-dream3r-ver21-state-training-metrics.md` | 2026-05-30 ver2.1 refinement spec. Makes trained state quality the next bottleneck, adds depth/coherence-aligned state objectives, and requires patch-oracle / temporal / scale-drift metrics before claiming Memory/Anchor/NSA value |
