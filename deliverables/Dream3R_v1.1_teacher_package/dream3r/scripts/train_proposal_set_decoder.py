"""Train ProposalSetDecoder from cached expert proposal banks.

The cache contract excludes invalid placeholder proposals. Evaluation compares
the learned decoder with per-expert and oracle references using the metrics in
``train_scf_head``.
"""
