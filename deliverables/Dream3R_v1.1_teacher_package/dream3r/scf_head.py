"""Multi-expert state-conditioned fusion head.
...
Softmax-weighted convex fusion keeps the output inside the proposal hull and
avoids the instability of an unrestricted residual. Residual correction is
available behind a flag and remains disabled in the official ETH3D policy.
