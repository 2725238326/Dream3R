"""State-conditioned proposal-set reconstruction decoder.

The decoder consumes cached pointmaps from multiple 3R experts together with
Dream state features and predicts a bounded final pointmap.
...
scale-normalized proposal pointmaps, keeping the result bounded while adding
more capacity than an independent per-expert scorer.
"""
