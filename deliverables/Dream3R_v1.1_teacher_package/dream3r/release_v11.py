"""Dream3R v1.1.0 domain-conditional inference entry point.

This module exposes the current official Dream3R policy as a stable callable
surface:

* KITTI-style windows use the validated v1.0-rc1 ProposalSetDecoder branch.
* ETH3D-style windows use the VGGT-Omega-expanded SCF head.

Image experts run upstream. This module consumes their proposal bank together
with Dream state tensors and returns the fused reconstruction.
"""
