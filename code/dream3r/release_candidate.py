"""Official Dream3R v1.0-rc1 release-candidate wrapper.

This module turns the selected architecture into a stable import surface. It
does not replace the historical frozen core model; v1.0-rc1 is the bounded
proposal-fusion release path selected in the release package.
"""
