"""Dream3R non-core state-only expert prior head.

This diagnostic head intentionally removes proposal geometry and confidence
from the weighting network. It asks a narrow question: can Dream state
(``memory_context`` + conflict score) predict useful expert mixture weights?
